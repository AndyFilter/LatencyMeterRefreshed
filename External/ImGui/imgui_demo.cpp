...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Drag/Slider Flags"))
    {
        ...
        ImGui::SameLine(); HelpMarker("Always clamp value to _min/_max bounds (if any) when input manually with CTRL+Click.");
    ...
    if (ImGui::TreeNode("Data Types"))
    {
        ...
        //   bool MySliderU64(const char *label, u64* value, u64 _min = 0, u64 _max = 0, const char* format = "%lld")
        //   {
        //      return SliderScalar(label, ImGuiDataType_U64, value, &_min, &_max, format);
        //   }
